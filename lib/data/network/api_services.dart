...
class ApiServices extends BaseApiServices {
  @override
  Future getApi(String url, String place) async {
    var jsonData;
    try {
      var response = await http.get(Uri.parse(url+ place +"?unitGroup=metric&key=7JWQMV9WC5JJBUQF22L83ERCB&contentType=json")).timeout(
